...
from SISGDDO.views_sisgddo import nomsosi
...
from SISGDDO.views_sisgddo import nomtipo_codigo, tipo_codigo_update
...
urlpatterns = [
    ...
    path('listar/tipo-codigo', views_sisgddo.listar_tipo_codigo, name = "listar_tipo_codigo"),
    path('adicionar/tipo-codigo', nomtipo_codigo.as_view(), name = "agregar_tipo_codigo"),
    path('modificar/tipo-codigo/<int:pk>', tipo_codigo_update.as_view(), name="modificar_tipo_codigo"),
    path('activar/tipo-codigo/<int:id>/', views_sisgddo.act_desacttipo_codigo, name="act_desacttipo_codigo"),
    path('eliminar/tipo-codigo/<int:id>/', views_sisgddo.eliminar_tipo_codigo, name="eliminar_tipo_codigo"),
    ...
    path('prueba', views_sisgddo.prueba, name = "prueba"),
    ##########################################################################################
    # CRUD nomenclador tipo de obra Dayana
    path('listar/tipo-de-obra', views_sisgddo.listar_tipo_de_obra,
         name="listar_tipo_de_obra"),
    path('agregar/tipo-de-obra', nomtipodeobra.as_view(),
         name="agregar_tipo_de_obra"),
    path('modificar/tipo-de-obra/<int:pk>',
         tipo_de_obra_update.as_view(), name="modificar_tipo_de_obra"),
    path('activar/tipo-de-obra/<int:id>/',
         views_sisgddo.act_desacttipodeobra, name="act_desacttipodeobra"),
    path('eliminar/tipo_de_obra/<int:id>/',
         views_sisgddo.eliminar_tipo_de_obra, name="eliminar_tipo_de_obra"),

    # CRUD afectaciones #hermes
    path('listar/afectacion', views_sisgddo.listar_afectacion,
         name="listar_afectacion"),
    ...
    path('listar/auditoriasinternas', views_sisgddo.listar_auditoriainterna,
         name="listar_auditoriainterna"),
    path('listar/auditoriasexternas', views_sisgddo.listar_auditoriaexterna,
         name="listar_auditoriaexterna"),

    # CRUD nomenclador estado_cenda
    path('listar/estado-cenda', views_sisgddo.listar_estado_cenda,
         name="listar_estado_cenda"),
    path('agregar/estado-cenda', nomestado_cenda.as_view(),
         name="agregar_estado_cenda"),
    path('modificar/estado-cenda/<int:pk>',
         estado_cenda_update.as_view(), name="modificar_estado_cenda"),
    path('activar/estadao-cenda/<int:id>/',
         views_sisgddo.act_desactestadocenda, name="act_desactestadocenda"),
    path('eliminar/estado-cenda/<int:id>/',
         views_sisgddo.eliminar_estado_cenda, name="eliminar_estado_cenda"),
...
#     path('administration/grupo/list',
#          login_required(views.group_list), name="group_list"),
#     path('administration/grupo/create',
#          login_required(views.group_create), name='group_create'),
#     path('administration/grupo/update/<int:pk>',
#          permission_required('ProyectoBaseApp.change_group', login_url='ce_login')(
#              forms.GroupUpdate.as_view()),
#          name='group_update'),
#     path('administration/grupo/delete/<int:pk>/',
#          permission_required('ProyectoBaseApp.delete_group', login_url='ce_login')(
#              forms.GroupDelete.as_view()),
#          name='group_delete'),
#     path('administration/user/list',
#          login_required(views.user_list), name="user_list"),
#     path('administration/user/create',
#          login_required(views.user_create), name='user_create'),
#     path('administration/user/update/<int:pk>',
#          login_required(forms.UserUpdate.as_view()), name='user_update'),
#     path('administration/user/delete/<int:pk>/',
#          login_required(forms.UserDelete.as_view()), name='user_delete'),
#     path('administration/password/update/<int:pk>/',
#          login_required(views.password_update), name='password_update'),
...
#          name='password_updateadmin'),
    ...
    path('user/update/<int:pk>',
         login_required(forms.UserUpdateAdmin.as_view()), name="profile"),
    ...
    path('detalle/auditoriaint/<int:pk>/',
         views_sisgddo.AuditoriaInternaDetailView.as_view(), name="detalle_auditoriaint"),
    path('detalle/auditoriaext/<int:pk>/',
         views_sisgddo.AuditoriaExternaDetailView.as_view(), name="detalle_auditoriaext"),
    path('listar/auditoriainterna/',
         views_sisgddo.listar_auditoria_interno, name="listar_auditoriaint"),
    path('adicionar/auditoriainterna/',
         views_sisgddo.auditoria_interna_create, name="agregar_auditoriaint"),
    path('modificar/auditoriainterna/<int:pk>',
         auditoria_internaUpdate.as_view(), name="modificar_auditoriaint"),
    path('listar/auditoriaexterna/',
         views_sisgddo.listar_auditoria_externa, name="listar_auditoriaext"),
    path('listar/auditoriaexterna/',
         views_sisgddo.listar_auditoria_externa, name="listar_auditoriaext"),
    path('adicionar/auditoriaexterna/',
    ...
    #     #Gestion Información
    path('listar/incidencias', views_sisgddo.listar_incidencias,
         name="listar_incidencias"),
    path('listar/no_conformidad', views_sisgddo.listar_no_conformidad,
    ...
    path('detalle/reservas/<int:pk>/',
         views_sisgddo.det_reservasdecuadro, name="detalle_reservas"),
    path('listar/cuadros', views_sisgddo.listar_cuadro, name="listar_cuadros"),
    path('detalle/cuadros/<int:pk>/',
         views_sisgddo.det_cuadro, name="detalle_cuadros"),
    path('adicionar/incidencia/', views_sisgddo.incidencias_create,
         name="agregar_incidencia"),
    path('modificar/incidencia/<int:pk>',
         incidenciaUpdate.as_view(), name="modificar_incidencia"),
    path('listar/acuerdos', views_sisgddo.listar_acuerdos, name="listar_acuerdos"),
    path('adicionar/acuerdos', views_sisgddo.acuerdo_create,
         name="adicionar_acuerdos"),
    ...
    path('conformidadeficacia_act_des/<int:id>/',
         views_sisgddo.act_desactconformidadEficacia, name="act_desactConfEficacia"),
    ...
    path('clienteext_act_des/<int:id>/',
         views_sisgddo.act_desactClienteExterno, name="act_desactclienteext"),
    path('adicionar/clasificacioninc', views_sisgddo.nomclasificacionincidencias.as_view(),
         name="agregar_clasificacioninc"),
    path('listar/clasificacioninc', views_sisgddo.listar_clasificacionincidencias,
         name="listar_clasificacioninc"),
    path('modificar/clasificacioninc/<int:pk>',
         views_sisgddo.clasificacionincidenciasUpdate.as_view(), name="modificar_clasificacioninc"),
    ...
    path('exportar_pdf/incidencias',
         views_sisgddo.ExportarIncidencias_PDF.as_view(), name="exportar_incidencias"),
    path('exportar_pdf/reclamaciones',
         views_sisgddo.ExportarReclamaciones_PDF.as_view(), name="exportar_reclamaciones"),
    path('exportar_pdf/cursos', views_sisgddo.ExportarCapacitacion_PDF.as_view(),
         name="exportar_capacitacion"),
    path('exportar_pdf/licencias',
         views_sisgddo.ExportarLicencias_PDF.as_view(), name="exportar_licencias"),
    path('exportar_pdf/certificaciones',
         views_sisgddo.ExportarCertificaciones_PDF.as_view(), name="exportar_certific"),
    path('exportar_pdf/cuadros',
         views_sisgddo.ExportarCuadros_PDF.as_view(), name="exportar_cuadros"),
    path('exportar_pdf/reservas',
         views_sisgddo.ExportarReservas_PDF.as_view(), name="exportar_reservas"),
    path('exportar_pdf/proyatrasado',
         views_sisgddo.ExportarProyectAtrasados_PDF.as_view(), name="exportar_proy_atrasado"),
    path('exportar_pdf/proyaprob', views_sisgddo.ExportarProyectAprobados_PDF.as_view(),
         name="exportar_proy_aprobado"),
    ...
    path('exportar_pdf/proyterm',
         views_sisgddo.ExportarProyectTerminado_PDF.as_view(), name="exportar_proy_term"),
    path('exportar_pdf/proyform',
         views_sisgddo.ExportarProyectFormatos_PDF.as_view(), name="exportar_proy_form"),
    path('exportar_pdf/proyestados',
         views_sisgddo.ExportarProyectEstadosTodos_PDF.as_view(), name="exportar_proy_estados"),
    path('exportar_pdf/eficacia',
         views_sisgddo.ExportarEficacia_PDF.as_view(), name="exportar_eficacia"),
    path('informe/certificacion',
         views_sisgddo.ReporteCertificacionesJefeProyectos, name="reporte_cert"),
    path('informe/reclamacion', views_sisgddo.ReporteReclamaciones,
         name="reporte_reclam"),
    path('informe/incidencia', views_sisgddo.ReporteIncidencias, name="reporte_inc"),
    path('informe/capacitacion',
         views_sisgddo.ReporteCapacitaciones, name="reporte_cap"),
    ...
    path('informe/proyatrasado', views_sisgddo.ReporteProyectoAtrasado,
         name="reporte_proyecto_atrasado"),
    path('informe/proyaprob', views_sisgddo.ReporteProyectoAprobado,
         name="reporte_proyecto_aprobado"),
    ...
    path('informe/proyterm', views_sisgddo.ReporteProyectoTerminado,
         name="reporte_proyecto_term"),
    path('informe/proyformato', views_sisgddo.ReporteProyectosFormatos,
         name="reporte_proyecto_format"),
    path('informe/proyestados', views_sisgddo.ReporteProyectosEstadosTodos,
         name="reporte_proyecto_estados"),
