...
from SISGDDO.views_sisgddo import DashboardGraficoLine,DashboardGraficopastel,AcuerdosConsejoDetailView, detalle_consecutivo, nomlinea_tematica,nomestado_proyecto,nomformato
...
urlpatterns = [
    ...
    path('validar/', views.validar, name='validar_pass'),
