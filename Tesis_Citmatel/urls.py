...
from SISGDDO.views_sisgddo import DashboardGraficoLine, DashboardGraficopastel, IncidenciasDetailView, detalle_consecutivo, incidenciaUpdate, auditoria_internaUpdate, auditoria_externaUpdate, nomlinea_tematica, nomestado_proyecto, nomformato, procesoUpdate, nomproceso
...
# handler500 = 'ProyectoBaseApp.views.error500'
# handler403 = 'ProyectoBaseApp.views.error403'
...
#     path('user/update/<int:pk>',login_required(forms.UserUpdate.as_view()),name='profile'),
