...
const CreatePlan = function () {
    ...
    const initEvent = function () {
        ...
        if($('#id_contcheck')[0].checked) {
            $('#id_contacto').attr('disabled', false);e
        }else {
            $('#id_contacto').attr('disabled', true);
        }
        });
        ...
        $('#form_submit').click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    Swal.fire({
                        title: '¡La actividad se ha creado satisfactoriamente!',
                        type: 'success',
                        timer: 2000,
...
var form = document.getElementById("form_create_plan");
...
$.ajax({
    ...
    {
        window.location.replace(listar_plan);
    },
