...
const UpdateProcessClassifier = function () {
    const form = $("#form_update_process_classifier");
        ...
        $('#form_submit').click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    Swal.fire({
                        title: '¡El Clasificador de proceso se ha registrado satisfactoriamente!',
                        type: 'success',
                        timer: 2000,
