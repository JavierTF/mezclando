...
const CreateTypeLegalDocument = function () {
    const form = $("#form_create_typelegaldocument");
        ...
        $('#form_submit').click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    Swal.fire({
                        title: '¡El Tipo de documento legal se ha registrado satisfactoriamente!',
                        type: 'success',
                        timer: 2000,
