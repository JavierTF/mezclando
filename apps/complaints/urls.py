...
from apps.complaints.views import ReceptionView, create_reception, update_reception, activate_reception, delete_reception, \
...
urlpatterns = [
    ...
    path('activar/via_de_recepcion/<int:reception_id>/', activate_reception, name='activate_reception'),
