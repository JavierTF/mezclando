...
const CreateIndicator = function () {
    var list_measurers = [];
    const form = $("#form_create_indicator");
    ...
    const initEvent = function () {
        ...
        $('#add_measurer').on('click', function () {
            ...
            var html = '<tr>';
            html += '<td>' + (list_measurers.length) + '</td><td>' + name.val() + '</td><td>' + qualification.val() + '</td><td><a class="btn btn-sm btn-default" onclick="CreateIndicator.editMeasurer(\'' + name.val() + '\', \'' + qualification.val() + '\')"><i class="fa fa-edit"></i></a> <a class="btn btn-sm btn-default" onclick="CreateIndicator.removeMeasurer(\'' + name.val() + '\')"><i class="fa fa-trash"></i></a></td>';
            html += '</tr>';
